	...
	var body: some View {
		VStack(alignment: .leading, spacing: 0) {
			List {
				...
				Divider()
				AboutRowView(title: "Source Code:", detail:"Browse the codes", url: URL(string: "https://cothings.app/code"))
				Divider()
				AboutRowView(title: "Open Source Libraries:", detail:"3rd party libs", url: URL(string: "https://cothings.app/code"))
				Divider()
				AboutRowView(title: "Contact:", detail:"info@cothings.app", url: URL(string: "mailto:info@cothings.app?subject=iOS%20App"))
				Divider()
				AboutRowView(title: "Privacy", detail: "Learn details", url: URL(string: "https://\(UserDefaults.standard.string(forKey: ServerHostNameKey) ?? "")/privacy"))
				Divider()
